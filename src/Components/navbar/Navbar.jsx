        ...
        <div className="nav-item item-center">
          <nav className="menu" style={click ? styleB : styleA}>
            <ul className="menu-main">
              ...
              >
                <Link to={`/product?categories=beautycare`}>BEAUTY<sup style={{color:'red'}}>New</sup></Link>
              </li>
              <li
                className="menuItem"
                onClick={() => handleClick("categories", "beautycare")}
              >
                <Link to={`/product?categories=beautycare`}>3D STUDIO<sup style={{color:'red'}}>New</sup></Link>
              </li>
